...
public class SmartBearUtils {
    //method's goal is to create a util that will do login function for smartbear
...
//this method should cover step3,4,5
    public static void negatieLoginForSmartBear(WebDriver driver,String userID,String passwordID){
